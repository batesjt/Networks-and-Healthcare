...
int generate_random(string inputFile)
{
...
PYBIND11_MODULE(main_adv, m) {
    m.doc() = "pybind11 example plugin"; // optional module docstring

    m.def("generate_random", &generate_random, "A function that adds two numbers");
}